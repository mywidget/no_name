                ...
                <tbody> 
                    <?php 
                        ...
                        foreach ($record as $row){
                            ...
                            $hapus = '<a class="btn btn-danger" data-id="'.$kode.'" data-bs-toggle="modal" data-bs-target="#confirm-delete-kelas" href="#"><i class="fa fa-trash"></i>&nbsp;&nbsp;Hapus Data</a>';
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <div class="btn-group btn-group-sm">
                                    <a href='javascript:void(0);' class="btn btn-primary" data-bs-toggle='modal' data-bs-target='#OpenModalKelas' data-id='<?=$kode;?>' data-mod='edit' class='openPopup text-info'><i class="ti ti-edit"></i>&nbsp;&nbsp;Edit</a>
                                    <?=$hapus;?>
                                </div>
                            </td>
                        </tr>
