                                    ...
                                    <div class="col-md-6 col-sm-6 mb-0 pb-0">
										<div class="pull-right ml-5 pl-5 ml-4">
                                            ...
                                            <p class="m-l-5 text-body">
                                                <br/><span class="border border-dark p-1">L. MAT 07</span>
											<br/></p>
											...
											<tbody class="border-bottom  border-dark">
												<?php 
													...
													foreach($divisi as $rows){
														...
														//r2
														$jml_r2 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,83,$materiel);
														//r4
														$jml_r4 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,84,$materiel);
