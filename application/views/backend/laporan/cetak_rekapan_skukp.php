                                    ...
                                    <div class="col-md-6 col-sm-6 mb-0 pb-0">
										<div class="pull-right ml-5 pl-5 ml-4">
                                            ...
                                            <p class="m-l-5 text-body">
                                                <br/><span class="border border-dark p-1">L. MAT 11</span>
											<br/></p>
									...
									<div class="col-md-12 mt-0 pt-0">
										<table class="table border border-dark" style="font-size:8.6pt;margin-bottom: 5px;">
											<thead class="border border-dark">
												...
												<tr>
													<td class="text-center align-middle border border-dark" style="width:74px">R2</td>
													<td class="text-center align-middle border border-dark" style="width:74px">R4</td>
											...
											<tbody class="border-bottom  border-dark">
												<?php 
													...
													foreach($divisi as $rows){
														...
														//r2
														$jml_r2 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,231,$materiel);
														//r4
														$jml_r4 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,232,$materiel);
														
														$total = $jml_r2 + $jml_r4;
														// $penerimaan = $this->model_mutasi->real_stok_tag_divisi($materiel,$rows->id,$dari,$sampai) + $total;
														$penerimaan = $awal['penerimaan_divisi'];
														
														$sisa = $stok_awal + $penerimaan - $total;
													...
													<tr>
														...
														<td class="text-right font-weight-bold border border-dark"><?=nomor($jml_r2);?></td>
														<td class="text-right font-weight-bold border border-dark"><?=nomor($jml_r4);?></td>
											...
											<tfoot>
												<tr>
													...
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_r2);?></td>
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_r4);?></td>
