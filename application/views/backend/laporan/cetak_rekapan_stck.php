										...
										<table class="table border border-dark" style="font-size:8.6pt;margin-bottom: 5px;">
											...
											<tbody class="border-bottom  border-dark">
												<?php 
													...
													foreach($divisi as $rows){
														...
														//r2
														$jml_r2 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,80,$materiel);
														//r4
														$jml_r4 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,81,$materiel);
											...
											<tfoot>
												<tr>
													...
													<td class="text-right font-weight-bold border border-dark"><?=$sum_r2;?></td>
													<td class="text-right font-weight-bold border border-dark"><?=$sum_r4;?></td>
													<td class="text-right font-weight-bold border border-dark"><?=nomor($sum_jumlah);?></td>
													<td class="font-weight-bold border border-dark">&nbsp;</td>
													<td class="text-right font-weight-bold border border-dark"><?=nomor($sum_sisa + $sisa_stok);?></td>
													<td class="font-weight-bold border border-dark">&nbsp;</td>
												</tr>
											</tfoot>
										</table>
