                                    ...
                                    <div class="col-md-6 col-sm-6 mb-0 pb-0">
										<div class="pull-right ml-5 pl-5 ml-4">
                                            ...
                                            <p class="m-l-5 text-body">
                                                <br/><span class="border border-dark p-1">L. MAT 02</span>
											<br/></p>
										...
										<table class="table border border-dark" style="font-size:8.6pt;margin-bottom: 5px;">
											<thead class="border border-dark">
												<tr class="border border-dark">
													...
													<td colspan="8" align="center" class="text-center align-middle border border-dark" style="padding:5px 0 5px!important">PENGGUNAAN</td>
												...
												<tr>
													...
													<td colspan="2" align="center" class="text-center align-middle border border-dark" style="width:70px">PERPANJANGAN</td>
													<td colspan="2" align="center" class="text-center align-middle border border-dark" style="width:70px">PERUBAHAN</td>
											...
											<tbody class="border-bottom  border-dark">
												<?php 
													...
													$sum_6 = $sum_7 = $sum_8 = $sum_6 = $sum_7 = $sum_8 = $sum_9 = $sum_10 = $sum_11 = $sum_12 = $sum_13 = 0;
													...
													foreach($divisi as $rows){
														...
														//r2 baru
														$jml_6 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,32,$materiel);
														$jml_7 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,36,$materiel);
														$jml_8 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,33,$materiel);
														$jml_9 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,37,$materiel);
														$jml_10 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,34,$materiel);
														$jml_11 = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,38,$materiel);
														
														$jml_12 = $jml_6 + $jml_8+  $jml_10;
														$jml_13 = $jml_7 + $jml_9 + $jml_11;
														
														$penerimaan = $awal['penerimaan_divisi'];
														
														$sisa = $stok_awal + $penerimaan - $jml_12 - $jml_13;
