                                    ...
                                    <div class="col-md-6 col-sm-6 mb-0 pb-0">
										<div class="pull-right ml-5 pl-5 ml-4">
                                            ...
                                            <p class="m-l-5 text-body">
                                                <br/><span class="border border-dark p-1">L. MAT 06</span>
											<br/></p>
										...
										<table class="table border border-dark" style="font-size:8.6pt;margin-bottom: 5px;">
											<thead class="border border-dark">
												<tr class="border border-dark">
													<td class="text-center align-middle border border-dark" rowspan="2">NO</td>
													<td class="text-center align-middle border border-dark" rowspan="2">KESATUAN</td>
													<td class="text-center align-middle border border-dark" rowspan="2">STOK AWAL</td>
													<td class="text-center align-middle border border-dark" rowspan="2">PENERIMAAN</td>
													<td class="text-center align-middle border border-dark" rowspan="2">PENDISTRIBUSIAN</td>
													<td class="text-center align-middle border border-dark" style="padding:5px 0 5px!important" colspan="3">PENGGUNAAN</td>
													<td class="text-center align-middle border border-dark" rowspan="2">RUSAK</td>
													<td class="text-center align-middle border border-dark" rowspan="2">SISA STOK SEKARANG</td>
													<td class="text-center align-middle border border-dark" rowspan="2">KET</td>
												</tr>
												<tr>
													<td class="text-center align-middle border border-dark" style="width:74px">TCKB</td>
													<td class="text-center align-middle border border-dark" style="width:74px">CD</td>
													<td class="text-center align-middle border border-dark" style="width:74px">JUMLAH</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="font-weight-bold border border-dark">&nbsp;</td>
													<td class="font-weight-bold border border-dark">&nbsp;</td>
													<td class="text-right font-weight-bold border border-dark"><?=nomor($sisa_stok);?></td>
													<td class="font-weight-bold border border-dark">&nbsp;</td>
												</tr>
											...
											<tbody class="border-bottom  border-dark">
												<?php 
													...
													foreach($divisi as $rows){
														...
														$awal = stok_awal_divisi_tckb($id_master,$rows->id,$dari,$sampai);
														...
														//r2
														$jml_tckb = penggunaan_by_id_form('cc_terjual',$rows->id,$dari,$sampai,234,$materiel,'tag');
														$jml_cd = 0;
														
														$total = $jml_tckb + $jml_cd;
														// $penerimaan = $this->model_mutasi->real_stok_tag_divisi($materiel,$rows->id,$dari,$sampai) + $total;
														$penerimaan = $awal['penerimaan_divisi'];
														
														$sisa = $stok_awal + $penerimaan -$jml_distribusi - $total;
													...
													<tr>
														...
														<td class="text-right font-weight-bold border border-dark"><?=nomor($jml_tckb);?></td>
														<td class="text-right font-weight-bold border border-dark"><?=nomor($jml_cd);?></td>
														<td class="text-right font-weight-bold border border-dark"><?=nomor($total);?></td>
														<td class="font-weight-bold border border-dark">&nbsp;</td>
											...
											<tfoot>
												<tr>
													...
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_stok+$stok_awal_gudang);?></td>
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_penerimaan + $stok_penerimaan);?></td>
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_distribusi+$stok_pengiriman);?></td>
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_tckb);?></td>
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_cd);?></td>
													<td class="text-right font-weight-bold border border-dark"><?=sum_jml($sum_jumlah);?></td>
													<td class="font-weight-bold border border-dark">&nbsp;</td>
