...
<html lang="en">
	...
	<?php
		...
		$status_keluarga = $statusMap[$s['status_keluarga']] ?? $s['status_keluarga'];
	?>
	<body>
		<div class="container-fluid">
			<div class="d-flex justify-content-center">
				<img src="<?=tag_image('kop_surat');?>" alt="<?=tag_key('kop_surat');?>" width="900" />
			</div>
			<table class="green-white mt-4">
				...
				<tr><td>9. Status dalam keluarga</td>   <td>:</td> <td><?=$status_keluarga;?></td></tr>
