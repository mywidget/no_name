...
<main class="container" id="formulir">
    <h4 class="mt-5 mb-4 db-primary">Formulir Pendaftaran Santri Baru <?php echo $tahun['nama_tahun'];?></h4>
        ...
        <ol type="I">
            ...
            <div class="container p-0">
                ...
                <div class="row align-items-center mt-2">
                    ...
                    <div class="col-sm-9 col-md-8 col-lg-6">
                        <input type="number" name="anak_ke" id="anakKe" class="form-control" value="<?=$anak_Ke;?>" required="">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="row align-items-center mt-2">
                    ...
                    <div class="col-sm-9 col-md-8 col-lg-6">
                        <input type="number" name="dari" id="jumlahSaudara" class="form-control" value="<?=$dari;?>" required="">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="container p-0">
                ...
                <div class="row align-items-center mt-2">
                    ...
                    <div class="col-sm-9 col-md-8 col-lg-6">
                        <input type="tel" name="nomor_hp" id="telp" class="form-control" value="<?=$nomor_hp;?>" required="">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="row align-items-center mt-2">
            ...
            <div class="container p-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-9 col-md-8 col-lg-6">
                        <input type="text" name="alamat" id="alamat" class="form-control" required="" placeholder="Jl. Raden Intan No. 19" value="<?=$alamat;?>" >
                    </div>
                </div>
                <div class="row align-items-center mt-2">
                    <div class="col-sm-3 col-md-3 col-lg-2">
