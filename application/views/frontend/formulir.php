                    ...
                    <div class="row align-items-center mt-2">
                        ...
                        <div class="col-sm-9 col-md-8 col-lg-6 position-relative">
                            <select name="jenis_kelamin" id="gender" class="form-select" required="">
                                ...
                                <option value="<?=encrypt_url('Laki-laki')?>">Laki-laki</option>
                                <option value="<?=encrypt_url('Perempuan')?>">Perempuan</option>
                            </select>
                    ...
                    <div class="row align-items-center mt-2">
                        ...
                        <div class="col-sm-9 col-md-8 col-lg-6">
                            <select name="status_sekolah" id="statusPendidikan" class="form-select">
                                <option value="<?=encrypt_url('Baru')?>">Baru</option>
                                <option value="<?=encrypt_url('Pindahan')?>">Pindahan</option>
                            </select>
                        </div>
                    </div>
                    <div class="row align-items-center mt-2">
                        ...
                        <div class="col-sm-9 col-md-8 col-lg-6 position-relative">
                            <select id="form_unit" class="form-select" name="unit_sekolah" required="">
                                ...
                                <?php 
                                    ...
                                    ?>
                                    <option value="<?php echo encrypt_url($row['id']); ?>"><?php echo $row['nama_jurusan']; ?></option>
                                    <?php 
                                    }
                                ?>
                            </select>
                    ...
                    <div class="row align-items-center mt-2">
                        ...
                        <div class="col-sm-9 col-md-8 col-lg-6 position-relative">
                            <select name="pendidikan_terakhir_ayah" id="pendidikanAyah" class="form-select" required="">
                                ...
                                <option value="<?=encrypt_url($val->title);?>"><?=$val->title;?></option>
                                <?php endforeach;?>
                            </select>
        ...
        <script>
            $(document).ready(function() {
                function validateNumber(event) {
                    ...
                    if ([8, 46, 37, 39].includes(key)) { // Backspace, Delete, Arrow Keys
                        return true;
                    }
                    if (key < 48 || key > 57) { // Cegah karakter selain angka
                ...
                // Terapkan validasi angka untuk input yang membutuhkan
                $('#nik, #nisn, #nokk, #nikAyah, #nikIbu').on("keydown", validateNumber);
                $('#nik, #nisn, #nokk, #nikAyah, #nikIbu').on("input", enforceMaxLength);
