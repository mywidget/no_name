...
<input class="form-control" type="hidden" id="id_pendaftar" name="id_pendaftar" value="<?php echo encrypt_url($row['id']);?>" />
<div class="shadow rounded-12 p-3 mb-3">
    ...
    <div class="rounded-12 p-3">
        ...
        <div id="frames">
            ...
            ?>  
            <img class="img-thumbnail" id="img-bukti" style="width: 125px;" src="<?=$fotobukti;?>">
        </div>
    </div>
</div>
...
<div class="shadow rounded-12 p-3 mb-3">
    ...
    <div class="rounded-12 p-3">
        ...
        <div id="frames1">
            ...
            ?>  
            <img class="img-thumbnail" id="img-santri" style="width: 125px;" src="<?=$foto;?>">
        </div>
    </div>
</div>
...
<div class="shadow rounded-12 p-3 mb-3">
    ...
    <div class="rounded-12 p-3">
        ...
        <input class="form-control" type="file" id="foto_kk" name="foto_kk" accept="image/png, image/jpg, image/jpeg" required=""/>
        <br>
        <div id="frames2">
            <?php
            ...
            ?>  
            <img class="img-thumbnail" id="img-kk" style="width: 125px;" src="<?=$foto_kk;?>">
...
<div class="shadow rounded-12 p-3">
    ...
    <div class="rounded-12 p-3">
        ...
        <input class="form-control" type="file" id="surat" name="surat" accept="" required=""/>
        <br>
        <div id="frames2">
            <?php
            ...
            ?>  
            <img class="img-thumbnail" id="img-surat" style="width: 125px;" src="<?=$surat;?>">
