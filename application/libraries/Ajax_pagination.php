...
class Ajax_pagination{
    ...
    var $uri_segment     = 3;
    var $full_tag_open   = '<ul class="pagination pagination-responsive float-end">';
    var $full_tag_close  = '</ul>';
    var $first_tag_open  = '<li class="page-item disabled"><a class="page-link" href="#">&nbsp;';
    ...
    var $loading         = '.loading';
    var $show_tag_open   = '<ul class="pagination pagination-responsive float-start">';
    var $show_tag_close  = '</ul>';
	var $link_info_l	= '<li class="page-item disabled d-none d-sm-inline-block"><a href="javascript:void(0);" class="page-link">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<span class="d-none d-sm-inline-block">Menampilkan ' . $this->total_rows . '</span>';
            return $info;
        }
